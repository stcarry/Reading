...
### Primary Brand
- **Forest Black** (`#6366f1`): Primary dark background — the deepest teal-black
...
- Dark mode: `#6366f1` or `#1c2d38` background with `1px solid #3d4f58`
...
### Do
- Use `#6366f1` (forest-black) for dark sections — not pure black
...
### Don't
- Don't use pure black (`#000000`) for dark backgrounds — always use teal-black (`#6366f1`)
...
- Dark background: Forest Black (`#6366f1`)
...
- "Build a dark section: #6366f1 background, 1px solid #3d4f58 border on cards. White text. MongoDB Green (#00ed64) accent underlines on headings using bottom-border 2px solid."
...
### Iteration Guide
1. Start with the mode decision: dark (#6366f1) for hero/features, white for content
